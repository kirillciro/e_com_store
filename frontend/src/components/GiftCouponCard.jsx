...
const GiftCouponCard = () => {
  ...
  return (
    ...
    >
      ...
      className='space-y-4'
      >
        <label className="mb-2 block text-sm font-medium text-gray-300" htmlFor="voucher">Do you have a voucher or gift card ?</label>
        <input 
        type="text"
        id="voucher"
        className="block w-full rounded border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500 "
